/**
 * 
 * @Author: Srinivas Tejomurthula
 * Co-Author: Shrestha Vure
 * 
 * html Editor backend code.
 */
...
function widgToolbarAction() {
	...
	toolBarWidget = this.parentNode.parentNode.widgToolbarObject;
	var theWidgEditor = theToolbar.widgEditorObject;
	var theIframe = theWidgEditor.theIframe;
	var theSelection = "";
